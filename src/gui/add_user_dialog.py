...
class XiaomiPage(QWizardPage):
    ...
    def _init_ui(self):
        ...
        self.device_combo.addItem("米家体脂秤 S400 白色", "yunmai.scales.ms103")
        self.device_combo.addItem("米家体脂秤 S400 蓝色", "yunmai.scales.ms107")
        self.device_combo.addItem("米家体脂秤 S400 Pro", "yunmai.scales.ms110")
        self.device_combo.addItem("Xiaomi Body Composition Scale S400(海外款)", "yunmai.scales.ms104")
        self.device_combo.addItem("米家八电极体脂秤 S800", "xiaomi.scales.ms116")
